...
-- Dumping data for table charger_db.charger_point: ~9 rows (approximately)
/*!40000 ALTER TABLE `charger_point` DISABLE KEYS */;
INSERT INTO `charger_point` (`point_id`, `name`, `location`, `status`, `uptime`, `downtime`, `plug1`, `plug2`, `max_volt1`, `max_volt2`, `max_a1`, `max_a2`, `emer_stat`, `plug1_type`, `plug2_type`, `zone`) VALUES
	(1, 'PHIHONG120-PTT', 'bangkok', 0, '48', NULL, 100, 45, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(2, 'PHIHONG120-BP', 'Nakhonpathom', 1, '48', NULL, 96, 120, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(3, 'PHIHONG120-CENTRAL', 'chonburi', 1, '48', NULL, 120, 30, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(4, 'PHIHONG120-PTT', 'chiangmai', 1, '0', NULL, 56, 76, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(5, 'PHIHONG120-PTT', 'chiangmai', 1, '0', NULL, 122, 115, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(6, 'PHIHONG120-LOTUS', 'rayong', 1, '0', NULL, 100, 103, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(7, 'PHIHONG120-LOTUS', 'rayong', 1, '0', NULL, 100, 89, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(8, 'PHIHONG120-BP', 'bangkok', 1, '0', NULL, 120, 76, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL),
	(9, 'PHIHONG120-BP', 'bangkok', 1, '0', NULL, 111, 76, 0, 0, 0, 0, 0, 'CCS2', 'CHAdeMO', NULL);
/*!40000 ALTER TABLE `charger_point` ENABLE KEYS */;
